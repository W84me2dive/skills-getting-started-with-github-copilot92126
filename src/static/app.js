              ...
              .map(
                (participant) => `
                  <li class="participant-item">
                    ...
                    <button type="button" class="remove-participant-btn" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant} from ${name}" title="Unregister ${participant}">
                      ✕
                    </button>
                  </li>
                `
